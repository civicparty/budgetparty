const modeChoices = [
  {
    ...
    guidewayChoices: [{
      ...
      id: 2,
      type: 'Fully Dedicated Lane',
      desc: 'Snackwave tbh ennui, squid jianbing lyft XOXO. Hoodie woke iPhone, etsy roof party locavore tote bag microdosing retro authentic raclette hammock venmo 90',
      image: 'modes/rapid_bus.jpg',
      oAndMCostPerRevMile: 70,
      averageSpeed: 35,
    ...
    guidewayChoices: [{
      id: 1,
      type: 'Fixed Rail with Mixed Traffic',
      desc: 'fixed guideway (rails); no dedication',
      image: 'modes/rapid_bus.jpg',
      oAndMCostPerRevMile: 180,
      averageSpeed: 8,
      capitalCostPerMile: 15000000,
      maintenanceCosts: 25000000,
    }, {
      id: 2,
      type: 'Fully Dedicated Fixed Railway',
    ...
    guidewayChoices: [{
      id: 1,
      type: 'Fixed Dedicated Guideway',
      desc: 'fixed guideway (rail); fully dedicated (median or curb)',
      image: 'modes/rapid_bus.jpg',
      oAndMCostPerRevMile: 250,
      averageSpeed: 30,
      capitalCostPerMile: 25000000,
